...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bulk_contact', 'contactname', self.gf('django.db.models.fields.CharField')(max_length=99, null=True))
    ...
    models = {
        'bulk.contact': {
            ...
            'contactname': ('django.db.models.fields.CharField', [], {'max_length': '99', 'null': 'True', 'blank': 'True'}),

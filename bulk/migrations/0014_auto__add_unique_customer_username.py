...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Customer', fields ['username']
        db.create_unique('bulk_customer', ['username'])


    def backwards(self, orm):
        # Removing unique constraint on 'Customer', fields ['username']
        db.delete_unique('bulk_customer', ['username'])

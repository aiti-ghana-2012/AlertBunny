...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.username'
        db.add_column('bulk_contact', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.username'
        db.delete_column('bulk_contact', 'username')
    ...
    models = {
        'bulk.contact': {
            ...
            'groupname': ('django.db.models.fields.CharField', [], {'default': "'unspecified'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),

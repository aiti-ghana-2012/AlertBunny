...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.activation_key'
        db.alter_column('bulk_customer', 'activation_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Customer.key_expires'
        db.alter_column('bulk_customer', 'key_expires', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Customer.activation_key'
        db.alter_column('bulk_customer', 'activation_key', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

        # Changing field 'Customer.key_expires'
        db.alter_column('bulk_customer', 'key_expires', self.gf('django.db.models.fields.DateTimeField')(default=''))

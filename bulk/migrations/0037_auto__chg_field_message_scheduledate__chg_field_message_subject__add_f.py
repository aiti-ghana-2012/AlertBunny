...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bulk_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
        # Adding field 'Customer.username'
        db.add_column('bulk_customer', 'username',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Message.scheduledate'
        db.alter_column('bulk_message', 'scheduledate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Message.subject'
        db.alter_column('bulk_message', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
        # Deleting field 'Customer.username'
        db.delete_column('bulk_customer', 'username')

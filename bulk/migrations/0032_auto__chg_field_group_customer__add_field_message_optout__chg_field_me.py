...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.customer'
        db.alter_column('bulk_group', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bulk.Customer']))
        # Adding field 'Message.optout'
        db.add_column('bulk_message', 'optout',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Group.customer'
        db.alter_column('bulk_group', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['bulk.Customer']))
        # Deleting field 'Message.optout'
        db.delete_column('bulk_message', 'optout')

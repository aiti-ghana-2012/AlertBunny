...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.customer'
        db.delete_column('bulk_contact', 'customer_id')


    def backwards(self, orm):
        # Adding field 'Contact.customer'
        db.add_column('bulk_contact', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='contacts', to=orm['bulk.Customer']),
                      keep_default=False)

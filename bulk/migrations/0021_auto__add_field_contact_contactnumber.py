...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.contactnumber'
        db.add_column('bulk_contact', 'contactnumber',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2, unique=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.contactnumber'
        db.delete_column('bulk_contact', 'contactnumber')


    models = {
        'bulk.contact': {
            'Meta': {'object_name': 'Contact'},
            'contactname': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'contactnumber': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'blank': 'True'}),
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contacts'", 'blank': 'True', 'to': "orm['bulk.Group']"}),
        ...
        'bulk.group': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'groups'", 'blank': 'True', 'to': "orm['bulk.Contact']"}),
